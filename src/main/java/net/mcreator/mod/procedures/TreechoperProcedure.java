...
public class TreechoperProcedure {
									...
									if ((itemstack).getDamageValue() == 0) {
										if (world instanceof Level _level) {
											if (!_level.isClientSide()) {
												_level.playSound(null, new BlockPos(entity.getX(), entity.getY(), entity.getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("mod:snoopdogremix")), SoundSource.NEUTRAL, 1, (float) 0.9);
											} else {
												_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("mod:snoopdogremix")), SoundSource.NEUTRAL, 1, (float) 0.9, false);
											}
										}
