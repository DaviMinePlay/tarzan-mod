...
import net.mcreator.mod.world.features.ores.KoronbekiOreFeature;
...
public class ModModFeatures {
	...
	public static final RegistryObject<Feature<?>> KORONBEKI_ORE = register("koronbeki_ore", KoronbekiOreFeature::feature,
			new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, KoronbekiOreFeature.GENERATE_BIOMES, KoronbekiOreFeature::placedFeature));
